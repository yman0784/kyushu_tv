...
# namespace :tv_program do
#   desc "テレビ欄をモデルに保存"
#   task tv_program_create:  :environment do
#     TvProgram.destroy_all
#     @tv = TvProgram.new
#     agent = Mechanize.new
...
#     @data.each do |d| 
#       TvProgram.create(title: d[:title], time: d[:time], overview: d[:overview], detail: d[:detail], performer: d[:act])
#     end
#   end
# end